        ...
        <TitledGreyBox css={tw`break-words`} title={name} icon={faServer}>
            ...
            <CopyOnClick text={primaryAllocation}>
                <p css={tw`text-xs mt-2`}>
                    <FontAwesomeIcon icon={faEthernet} fixedWidth css={tw`mr-1 text-mcm-400`}/>
                    <code css={tw`ml-1`}>{primaryAllocation}</code>
                </p>
            </CopyOnClick>
            <p css={tw`text-xs mt-2`}>
                <FontAwesomeIcon icon={faMicrochip} fixedWidth css={tw`mr-1 text-mcm-400`}/> {stats.cpu.toFixed(2)}%
                <span css={tw`text-neutral-500`}> / {cpuLimit}</span>
            </p>
            <p css={tw`text-xs mt-2`}>
                <FontAwesomeIcon icon={faMemory} fixedWidth css={tw`mr-1 text-mcm-400`}/> {bytesToHuman(stats.memory)}
                <span css={tw`text-neutral-500`}> / {memoryLimit}</span>
            </p>
            <p css={tw`text-xs mt-2`}>
                <FontAwesomeIcon icon={faHdd} fixedWidth css={tw`mr-1 text-mcm-400`}/>&nbsp;{bytesToHuman(stats.disk)}
                <span css={tw`text-neutral-500`}> / {diskLimit}</span>
            </p>
            <p css={tw`text-xs mt-2`}>
                <FontAwesomeIcon icon={faEthernet} fixedWidth css={tw`mr-1 text-mcm-400`}/>
                <FontAwesomeIcon icon={faArrowCircleUp} fixedWidth css={tw`mr-1 text-mcm-400`}/>{bytesToHuman(stats.tx)}
                <FontAwesomeIcon icon={faArrowCircleDown} fixedWidth css={tw`mx-1 text-mcm-400`}/>{bytesToHuman(stats.rx)}
            </p>
        </TitledGreyBox>
    );
};
