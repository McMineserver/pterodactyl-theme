...
const Navigation = styled.div`
    ${tw`w-full bg-mcm-500 shadow-md overflow-x-auto`};
    ...
    & #logo {
        ...
        & > a {
            ${tw`text-2xl font-header px-4 no-underline text-neutral-100 hover:text-neutral-50 transition-colors duration-150`};
        }
    }
`;
